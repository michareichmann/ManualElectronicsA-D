...
The NTC resistors we used for this experiment are not calibrated yet and therefore have a relatively large error on the absolute temperature scale.
\vspace{0.5cm}
\begin{center}
\fbox{
  \parbox{0.9\textwidth}{
...
\begin{itemize}
	...
	\item use the LM358 operational amplifier (with gain 1) to amplify the sensor signal. The pin layout is given in the datasheet or in figure \ref{fig:tempcircuit2}.
...
\subsection{Equilibrium temperature vs. fan RPM}
\begin{center}
\fbox{
  \parbox{0.9\textwidth}{
...
Also make sure, that you measure the equlibrium temperature without cooling. It might need few minutes to reach a stable equilibrium per point.
