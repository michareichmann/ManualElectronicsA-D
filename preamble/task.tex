...
\newlistof[chapter]{tasks}{tsk}{\listtaskname} % First bracket is \listof{what's in here}, second is the document that will be created, NameOfYourDoc.tsk in this case. Third is title of the list, what you define in above \newcommand.
%
